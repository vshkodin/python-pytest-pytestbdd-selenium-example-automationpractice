Feature: User Creates an account
    ...
    Scenario: User can create an account
        ...
        Then I set "email_create" input with "b11aaaa@test.com" value
        ...
        Then I validate "email" input contains "b11aaaa@test.com" value
    ...
    Scenario: User can log in account
        ...
        When I click on "Sign in" link
        Then I am on "Authentication" page
        Then I set "email" input with "b11aaaa@test.com" value
        Then I set "passwd" input with "testpass" value
